...
namespace Coaching_Classes {
    ...
    public partial class DataSet9 : global::System.Data.DataSet {
        ...
        public partial class STUDENTDataTable : global::System.Data.TypedTableBase<STUDENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public STUDENTRow AddSTUDENTRow(string S_ID, string SNAME, string COURSE, string SUBJECT, string FEES, string PAID, string REMFEES) {
...
namespace Coaching_Classes.DataSet9TableAdapters {
    ...
    public partial class STUDENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""KARUNA"".""STUDENT"" WHERE ((""S_ID"" = :Original_S_ID) AND (""SNAME"" = :Original_SNAME) AND (""COURSE"" = :Original_COURSE) AND (""SUBJECT"" = :Original_SUBJECT) AND (""FEES"" = :Original_FEES) AND (""PAID"" = :Original_PAID) AND (""REMFEES"" = :Original_REMFEES))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""KARUNA"".""STUDENT"" SET ""S_ID"" = :S_ID, ""SNAME"" = :SNAME, ""COURSE"" = :COURSE, ""SUBJECT"" = :SUBJECT, ""FEES"" = :FEES, ""PAID"" = :PAID, ""REMFEES"" = :REMFEES WHERE ((""S_ID"" = :Original_S_ID) AND (""SNAME"" = :Original_SNAME) AND (""COURSE"" = :Original_COURSE) AND (""SUBJECT"" = :Original_SUBJECT) AND (""FEES"" = :Original_FEES) AND (""PAID"" = :Original_PAID) AND (""REMFEES"" = :Original_REMFEES))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT S_ID, SNAME, COURSE, SUBJECT, FEES, PAID, REMFEES FROM KARUNA.STUDENT";
        ...
        public virtual int Fill(DataSet9.STUDENTDataTable dataTable) {
        ...
        public virtual DataSet9.STUDENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet9.STUDENTDataTable dataTable = new DataSet9.STUDENTDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet9.STUDENTDataTable dataTable) {
        ...
        public virtual int Delete(string Original_S_ID, string Original_SNAME, string Original_COURSE, string Original_SUBJECT, string Original_FEES, string Original_PAID, string Original_REMFEES) {
            ...
            if ((Original_PAID == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_PAID));
            }
            if ((Original_REMFEES == null)) {
                throw new global::System.ArgumentNullException("Original_REMFEES");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_REMFEES));
            }
        ...
        public virtual int Update(string S_ID, string SNAME, string COURSE, string SUBJECT, string FEES, string PAID, string REMFEES, string Original_S_ID, string Original_SNAME, string Original_COURSE, string Original_SUBJECT, string Original_FEES, string Original_PAID, string Original_REMFEES) {
            if ((S_ID == null)) {
            ...
            if ((REMFEES == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(REMFEES));
            }
            if ((Original_S_ID == null)) {
                throw new global::System.ArgumentNullException("Original_S_ID");
            }
            ...
            if ((Original_FEES == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_FEES));
            }
            if ((Original_PAID == null)) {
                throw new global::System.ArgumentNullException("Original_PAID");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_PAID));
            }
            if ((Original_REMFEES == null)) {
                throw new global::System.ArgumentNullException("Original_REMFEES");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_REMFEES));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SNAME, string COURSE, string SUBJECT, string FEES, string PAID, string REMFEES, string Original_S_ID, string Original_SNAME, string Original_COURSE, string Original_SUBJECT, string Original_FEES, string Original_PAID, string Original_REMFEES) {
            return this.Update(Original_S_ID, SNAME, COURSE, SUBJECT, FEES, PAID, REMFEES, Original_S_ID, Original_SNAME, Original_COURSE, Original_SUBJECT, Original_FEES, Original_PAID, Original_REMFEES);
        }
    }
